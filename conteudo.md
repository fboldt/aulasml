...
## Aula 2 — Regressão Linear e Métodos Básicos
...
## Aula 3 — Técnicas de Validação e Cross-Validation
...
## Aula 4 — Hyperparameter Tuning e AutoML
...
## Aula 5 — Classificação Binária e Multiclasse
...
## Aula 6 — K-Nearest Neighbors e Otimização
...
## Aula 7 — Support Vector Machines (SVM)
...
## Aula 8 — Modelos Probabilísticos
...
## Aula 10 — Dados Desbalanceados e Métricas Avançadas
...
## Aula 11 — Técnicas Avançadas de Validação

- Stratified K-Fold, Nested CV, LOOCV, TimeSeriesSplit
- Quando usar cada método; como evitar data leakage
- Relato de resultados: média e desvio, visualizações
- Exercícios de comparação entre estratégias

---

## Aula 12 — Engenharia e Seleção de Features
...
## Aula 13 — Clustering: K-Means e Variações
...
## Aula 14 — Outros Métodos de Clustering
...
## Aula 15 — Redução de Dimensionalidade
...
## Aula 16 — Séries Temporais e Forecasting
...
## Aula 18 — Semi-supervisionado e Active Learning
...
## Aula 19 — Sistemas de Recomendação
...
## Aula 21 — Algoritmos de Otimização (Genéticos, Swarm, SA)
...
## Aula 22 — Interpretabilidade e Explicabilidade
...
## Aula 23 — MLOps, Serialização e Deploy
...
## Aula 24 — Projeto Final, Revisão e Perspectivas
